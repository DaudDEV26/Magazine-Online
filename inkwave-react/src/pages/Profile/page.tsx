  ...
  return (
    <section className="py-16 bg-[#f8f9fa] dark:bg-[#0f0f1a] min-h-screen transition-colors duration-300">
      <div className="w-full max-w-[1000px] mx-auto px-5 flex flex-col gap-8">
        ...
        {/* Saved toast */}
        {saved && (
          <div className="fixed top-24 right-6 bg-[#2a9d8f] text-white px-5 py-3 rounded-xl shadow-lg font-semibold text-sm z-50 transition-all duration-300">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 -mt-10 mb-6">
              ...
              <button
                ...
                className={`px-5 py-2 rounded-full font-semibold text-sm transition-colors duration-200 cursor-pointer ${
                  editing
                    ? 'border-2 border-[#888888] text-[#888888] hover:border-[#e94560] hover:text-[#e94560]'
                    : 'bg-[#e94560] text-white hover:bg-[#d83550]'
                }`}
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <div key={i} className="bg-white dark:bg-[#1a1a2e] rounded-2xl shadow-[0_4px_15px_rgba(0,0,0,0.08)] p-5 text-center transition-colors duration-300">
          ...
          {/* Recent activity */}
          <div className="bg-white dark:bg-[#1a1a2e] rounded-2xl shadow-[0_4px_15px_rgba(0,0,0,0.08)] p-6 flex flex-col gap-4 h-fit transition-colors duration-300">
