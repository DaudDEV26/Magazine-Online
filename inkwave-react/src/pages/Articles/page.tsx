// inkwave-react/src/pages/Articles/page.tsx
        ...
        <div className="flex justify-center gap-2.5 mt-4">
          {[1, 2, 3].map(p => (
            <div
              ...
              className={`w-10 h-10 flex items-center justify-center rounded-full font-semibold shadow-[0_4px_15px_rgba(0,0,0,0.08)] cursor-pointer transition-colors duration-300 ${
                activePage === p ? 'bg-[#e94560] text-white' : 'bg-white text-[#1a1a2e] hover:bg-[#e94560] hover:text-white'
              }`}
            >
              {p}
            </div>
