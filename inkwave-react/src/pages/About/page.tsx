  ...
  return (
    <div className="bg-[#f8f9fa] dark:bg-[#0f0f1a] min-h-screen transition-colors duration-300">
        ...
        <div className="w-full max-w-[1200px] mx-auto">
          <div className="flex flex-wrap gap-6">
            {[
              ...
              <div key={i} className="flex-1 min-w-[260px] bg-white dark:bg-[#1a1a2e] rounded-2xl shadow-[0_4px_15px_rgba(0,0,0,0.08)] p-8 text-center flex flex-col gap-4 transition-colors duration-300">
      ...
      <section className="py-12 px-5 bg-[#1a1a2e] dark:bg-[#0a0a15]">
        <div className="w-full max-w-[1200px] mx-auto flex flex-wrap justify-center gap-6 text-center">
          {[
            ...
            <div key={i} className="w-[calc(50%-12px)] md:w-[calc(25%-18px)] flex flex-col gap-1">
        ...
        <div className="w-full max-w-[1200px] mx-auto flex flex-col gap-10">
          ...
          <div className="flex flex-wrap gap-6">
            {teamMembers.map((member, i) => (
              <div
                key={i}
                className="w-full sm:w-[calc(50%-12px)] lg:w-[calc(25%-18px)] bg-white dark:bg-[#1a1a2e] rounded-2xl shadow-[0_4px_15px_rgba(0,0,0,0.08)] p-6 flex flex-col items-center gap-4 text-center border-2 border-transparent hover:border-[#e94560] hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] hover:-translate-y-1 transition-all duration-300"
              >
                {/* Photo placeholder */}
