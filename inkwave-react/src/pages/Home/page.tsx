// inkwave-react/src/pages/Home/page.tsx
    ...
    <>
        ...
        <div className="w-full max-w-[1200px] mx-auto px-5 flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1 flex flex-col gap-5">
            ...
            <div className="flex gap-4 flex-wrap mt-2">
              <Link to="/articles" className="px-6 py-2.5 rounded-full font-semibold bg-[#e94560] text-white hover:bg-[#d83550] transition-colors duration-300">
                Read Now
              </Link>
              <a href="#newsletter" className="px-6 py-2.5 rounded-full font-semibold border-2 border-[#e94560] text-[#e94560] hover:bg-[#e94560] hover:text-white transition-colors duration-300">
                Subscribe
              </a>
            </div>
          </div>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="w-full max-w-[1200px] mx-auto px-5">
          <h2 className="font-serif text-3xl text-center mb-10 after:content-[''] after:block after:w-16 after:h-[3px] after:bg-[#e94560] after:mx-auto after:mt-2.5">
            Featured Articles
          </h2>
            ...
            {featuredArticles.map((a, i) => (
              <article key={i} className="w-full md:w-[calc(25%-15px)] bg-white rounded-2xl shadow-[0_4px_15px_rgba(0,0,0,0.08)] overflow-hidden border-2 border-transparent hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] hover:border-[#e94560] transition-all duration-300 flex flex-col">
                ...
                <div className="p-5 flex flex-col gap-2.5 flex-1">
                  ...
                  <Link to="/articles" className="mt-2 px-5 py-2 rounded-full font-semibold border-2 border-[#e94560] text-[#e94560] hover:bg-[#e94560] hover:text-white transition-colors duration-300 text-center text-sm">
                    Read More
                  </Link>
                </div>
              </article>
          ...
          <div className="flex flex-wrap justify-center gap-2.5">
            {trendingFilters.map(f => (
              <button
                ...
                className={`px-4 py-1.5 rounded-full text-sm font-semibold cursor-pointer transition-colors duration-300 ${
                  activeFilter === f
                    ? 'bg-[#e94560] text-white'
                    : 'bg-[#eef0f5] text-[#4a4a6a] hover:bg-[#e94560] hover:text-white'
                }`}
              >
        ...
        <div className="w-full max-w-[1200px] mx-auto px-5">
          ...
          <div className="flex flex-wrap gap-5">
            {browseCategories.map((c, i) => (
              <Link key={i} to="/categories" className="w-full md:w-[calc(25%-15px)] text-center bg-white p-10 rounded-2xl shadow-[0_4px_15px_rgba(0,0,0,0.08)] border-2 border-transparent hover:border-[#e94560] hover:-translate-y-1.5 transition-all duration-300 flex flex-col items-center gap-4">
      ...
      {/* ── Newsletter ── */}
      <section className="py-16 bg-[#f8f9fa]" id="newsletter">
        <div className="w-full max-w-[1200px] mx-auto px-5">
          <div className="bg-[#1a1a2e] text-white py-16 px-8 rounded-2xl flex flex-col items-center gap-5 text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-3 w-full max-w-[500px]" onSubmit={handleNewsletter}>
              ...
              />
              <button type="submit" className="px-6 py-3 rounded-full font-semibold bg-[#e94560] text-white hover:bg-[#d83550] transition-colors duration-300 cursor-pointer whitespace-nowrap">
                Subscribe
              </button>
            </form>
          </div>
